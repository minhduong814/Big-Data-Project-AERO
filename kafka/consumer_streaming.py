...
import os
KAFKA_ADDRESS = os.getenv('KAFKA_ADDRESS', os.getenv('KAFKA_HOST', 'localhost'))
KAFKA_BOOTSTRAP_SERVERS = os.getenv('KAFKA_BOOTSTRAP_SERVERS', f'{KAFKA_ADDRESS}:9092,{KAFKA_ADDRESS}:9093,{KAFKA_ADDRESS}:9094')
